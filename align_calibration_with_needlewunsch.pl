...
#	print Dumper($lib_amplicons_hash_ref);
	...
	my @potential_samples_dirs = ("CRISPR_MRE_Calibration", "Caribou_CRISPR_normalization", "HART_MRE_Calibration"); 
...
# debug only:			@all_input_mres_basenames = ("D_A8");
#				@all_input_mres_basenames = ("D_A7");
