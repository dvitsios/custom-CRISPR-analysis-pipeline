...
# depr: my @libs = ("A", "B", "C", "D");


my $MAX_NUM_OF_THREADS = 50;

#my $bin_dir = "out_bins";
#my $base_out_dir = "./needle_output";
my $bin_dir = "antons_bins";
my $base_out_dir = "./needle_output-antons_bins";
...
my @potential_samples_dirs = ("CRISPR_MRE_Sample", "HART_MRE_Sample", "Caribou_CRISPR", "CRISPR_MRE_Calibration", "Caribou_CRISPR_normalization", "HART_MRE_Calibration");
...
#				print "$input_dir exists! Starting samples mapping...\n";
				my @all_input_mres_basenames = glob("$input_dir/*_1.fq");
...
#								print "*** cur_amplicon: $cur_amplicon ***\n";
							...
							my $fq1 = "$input_dir/$cur_mre_basename"."_1.fq";
							`./conv_antons_fq_to_fa.pl  $fq1 $input_dir`;			
							...
							$fq2 = "$input_dir/$cur_mre_basename"."_2.fq";
							`./conv_antons_fq_to_fa.pl  $fq2 $input_dir`;			
